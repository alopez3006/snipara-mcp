...
TOOL_DEFINITIONS = [{'name': 'rlm_context_query',
  ...
  'inputSchema': {'type': 'object',
                  'properties': {'swarm_id': {'type': 'string'},
                                 ...
                                 'for_agent_id': {'type': 'string',
                                                  'description': 'Pre-assign task to specific '
                                                                 'agent (task affinity). If set, '
                                                                 'only this agent can claim the '
                                                                 "task. Use agent's agentId "
  ...
  'inputSchema': {'type': 'object',
                  'properties': {'swarm_id': {'type': 'string', 'description': 'Swarm ID'},
                                 ...
                                 'limit': {'type': 'integer',
                                           ...
                                           'description': 'Maximum tasks to return'},
                                 'cursor': {'type': 'string',
                                            'description': 'Cursor for pagination (from previous '
                                                           'response)'}},
                  'required': ['swarm_id']}},
 {'name': 'rlm_task_stats',
 ...
 {'name': 'rlm_task_reassign',
  ...
  'inputSchema': {'type': 'object',
                  'properties': {'swarm_id': {'type': 'string', 'description': 'Swarm ID'},
                                 ...
                                 'force': {'type': 'boolean',
                                           'default': False,
                                           'description': 'Force reassign even if task is '
 ...
 {'name': 'rlm_task_unclaim',
  ...
  'inputSchema': {'type': 'object',
                  'properties': {'swarm_id': {'type': 'string', 'description': 'Swarm ID'},
                                 'task_id': {'type': 'string', 'description': 'Task ID to unclaim'},
                                 'reason': {'type': 'string',
  ...
  'inputSchema': {'type': 'object',
                  'properties': {'swarm_id': {'type': 'string', 'description': 'Swarm ID'},
                                 'stuck_threshold_minutes': {'type': 'integer',
                                                             'default': 30,
                                                             'description': 'Minutes after which a '
                                                                            'task is considered '
                                                                            'stuck'},
                                 'dry_run': {'type': 'boolean',
                                             'default': True,
                                             'description': 'If true, only report stuck tasks '
                                                            'without recovering'}},
                  'required': ['swarm_id']}},
 {'name': 'rlm_upload_document',
  'description': 'Upload or update a document in the project. Supports text documents (.md, '
                 ...
                 '.pptx, .svg, .vsdx). Binary payloads should use base64:<payload> except SVG, '
                 'which may use raw XML.',
  'inputSchema': {'type': 'object',
 ...
 {'name': 'rlm_repl_context',
  'description': "Bridge between Snipara's context optimization and RLM-Runtime's code execution.\n"
                 ...
                 'injected into an rlm-runtime REPL session for context-aware code execution.\n'
                 '\n'
                 'WORKFLOW:\n'
  ...
  'inputSchema': {'type': 'object',
                  'properties': {'swarm_id': {'type': 'string', 'description': 'Swarm ID'},
                                 ...
                                 'workstreams': {'type': 'array',
                                                 'items': {'type': 'string'},
                                                 'description': 'Workstream types to create '
                                                                '(defaults to standard set)'},
                                 'workstream_owners': {'type': 'object',
                                                       'additionalProperties': {'type': 'string'},
                                                       'description': 'Map of workstream type to '
                                                                      "owner (e.g., {'API': "
                                                                      "'dev1', 'FRONTEND': "
                                                                      "'dev2'})"}},
                  'required': ['swarm_id', 'title', 'description', 'owner']}},
...
MCP_TOOL_NAMES = ['rlm_context_query',
 'rlm_search',
 'rlm_read',
 'rlm_code_callers',
 'rlm_code_imports',
