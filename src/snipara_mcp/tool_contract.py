"""Generated public MCP tool contract for the snipara-mcp package.
...
Only the advertised snipara_* tools are distributed here. Legacy handler names
remain an internal backend compatibility detail and are not part of the package
contract.
"""

from __future__ import annotations

TOOL_DEFINITIONS = [{'name': 'snipara_collaboration_status',
 ...
 {'name': 'snipara_end_of_task_commit',
  ...
  'inputSchema': {'type': 'object',
                  ...
                  'properties': {'summary': {'type': 'string',
                                             'maxLength': 200000,
                                             'description': 'Unstructured task summary used only '
                                                            'when why is absent'},
                                 'task': {'type': 'string',
                                          'maxLength': 700,
                                          'description': 'Short task label used as structured Why '
                                                         'Capture provenance'},
                                 'why': {'type': 'object',
                                         'additionalProperties': False,
                                         'description': 'Atomic Why Capture payload; never split '
 ...
 {'name': 'snipara_inbox_review_queue',
  ...
  'inputSchema': {'type': 'object',
                  'properties': {'limit': {'type': 'integer',
                                           ...
                                           'minimum': 1,
                                           'maximum': 50,
                                           'description': 'Maximum team Inbox items to return.'}},
                  'required': [],
                  'additionalProperties': False},
  'annotations': {'title': 'List the team review Inbox',
                  'readOnlyHint': True,
                  'destructiveHint': False,
                  'idempotentHint': True,
                  'openWorldHint': False}},
 ...
 {'name': 'snipara_inbox_review_apply',
  ...
  'inputSchema': {'type': 'object',
                  ...
                  'required': ['review_plan_id', 'reason', 'actions'],
                  'additionalProperties': False},
  'annotations': {'title': 'Apply an authorized team Inbox review',
                  'readOnlyHint': False,
                  'destructiveHint': True,
                  'idempotentHint': False,
                  'openWorldHint': False}},
